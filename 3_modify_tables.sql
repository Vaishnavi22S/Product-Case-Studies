...
\copy ecommerce_customer_churn_dataset FROM 'C:\Users\Dell\Documents\SQL_Projects\Ecommerce_churn\ecommerce_customer_churn_dataset.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
